...
(function (globals) {
  ...
  django.catalog = {
    ...
    "Course Video Settings": "Configuraci\u00f3n de video del curso", 
    ...
    "Enter the account information for your organization.": "Ingrese la informaci\u00f3n de cuenta para su organizaci\u00f3n.", 
    ...
    "Press change to change selected transcript provider.": "Presione Cambiar para cambiar el proveedor de transcripci\u00f3n seleccionado.", 
    ...
    "Specify any rules or rule exceptions that the proctoring review team should enforce when reviewing the videos. For example, you could specify that calculators are allowed. These specified rules are visible to learners before the learners start the exam.": "Especifique las reglas o excepciones de reglas que el equipo de revisi\u00f3n \u200b\u200bdeber\u00eda aplicar cuando revise los videos. Por ejemplo, puede especificar que las calculadoras est\u00e9n permitidas. Estas reglas espec\u00edficas son visibles para los estudiantes antes de que los alumnos comiencen el examen.", 
    ...
    "To receive credit for problems, you must select \"Submit\" for each problem before you select \"End My Exam\".": "Para que las respuestas sean calificadas, debe seleccionar \"Guardar respuesta\" para cada pregunta antes de seleccionar \"Terminar mi examen\".", 
    ...
    "Video Source Language": "Lenguaje fuente de video", 
    ...
    "You are taking \"{exam_link}\" as a {exam_type} exam. The timer on the right shows the time remaining in the exam.": "Est\u00e1s tomando \"{exam_link}\" como un examen {exam_type}. El temporizador a la derecha muestra el tiempo restante en el examen.", 
